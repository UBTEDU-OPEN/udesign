    ...
    <>
      <Demo.Page title='Result 结果反馈' description='用于反馈一系列操作任务的处理结果。'>
        ...
        <Demo.Block title='Success' description='成功的结果。'>
          <Result status='success' title='Successfully' subtitle='Your requirement has been successful'>
        ...
        <Demo.Block title='自定义 icon' description='自定义 icon'>
          <Result icon={<img src='/demo.svg' alt='' />} title='Great, we have done all the operations!'>
