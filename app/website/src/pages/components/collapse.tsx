    ...
    <>
      <Demo.Page title='Collapse 折叠面板' description='可以折叠/展开的内容区域。'>
        ...
        <Demo.Block title='手风琴' description='每次只能打开一个 tab。'>
          <Collapse accordion expandIcon={<DownOutlined />} headerStyle={{ backgroundColor: '#edf1ff', borderRadius: '30px', marginBottom: '10px' }} bodyStyle={{ backgroundColor: '#F3F4F8', borderRadius: '25px' }}>
            <Collapse.Item title='这里是标题1' name='1'>
              是一个致力于提升“用户”和“设计者”使用体验的多端设计语言。产品经理、交互设计师、视觉设计师、前端工程师、开发工程师等角色，在此统称为“设计者”，利用统一的规范进行设计赋能，帮助“设计者”提高多端产品体验和研发效率。U
              Design高度重视“设计者”的使用体验，践行敏捷开发的设计模式。
            </Collapse.Item>
        ...
        <Demo.Block title='有边框样式' description='一套有边框的简洁样式。'>
          <Collapse
            ...
            headerStyle={{ '--ud-collapse-item-header-background-color': '#edf1ff', '--ud-collapse-item-header-active-background-color': '#fff', '--ud-collapse-item-header-active-border-radius': '0px', marginBottom: '10px' }}
        ...
        <Demo.Block title='自定义面板' description='自定义各个面板的背景色、圆角、边距和图标。'>
          <Collapse activeKey='1' expandIcon={<DownOutlined />} headerStyle={{ background: '#fff', borderRadius: '5px' }} bodyStyle={{ background: '#EDF1FF', borderRadius: '5px' }}>
            <Collapse.Item title='这里是标题1' name='1'>
              是一个致力于提升“用户”和“设计者”使用体验的多端设计语言。产品经理、交互设计师、视觉设计师、前端工程师、开发工程师等角色，在此统称为“设计者”，利用统一的规范进行设计赋能，帮助“设计者”提高多端产品体验和研发效率。U
              Design高度重视“设计者”的使用体验，践行敏捷开发的设计模式。
            </Collapse.Item>
