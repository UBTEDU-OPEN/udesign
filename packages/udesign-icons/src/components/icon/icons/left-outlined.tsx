...
const SvgComponent = () => (
  <svg height='1em' viewBox='0 0 41 40' width='1em' xmlns='http://www.w3.org/2000/svg'>
    <path
      ...
      fill='currentColor'
      fillRule='evenodd'
      transform='matrix(-.70710678 -.70710678 .70710678 -.70710678 25.69323 46.340272)'
    />
  </svg>
);

const LeftOutlined = convertIcon(SvgComponent);
