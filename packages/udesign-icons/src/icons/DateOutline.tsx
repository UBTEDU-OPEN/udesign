...
function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox='0 0 40 41' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' width='1em' height='1em' focusable={false} aria-hidden={true} {...props}>
      ...
      <g fill='none' fillRule='evenodd' filter='url(#a)' stroke='currentColor' strokeWidth={2} transform='translate(-62 -90.5)'>
